...
#   PURPOSE: Email delivery orchestration for one-time registration verification messages
#   SCOPE: Verification URL construction, template rendering, provider dispatch, safe telemetry and token redaction boundaries
