...
def test_deploy_install_changes_are_phase35_scoped():
    approved_phase35_surface = {
        ...
        "deploy/haproxy-phase40.cfg",
        "deploy/mtproto-de-compose.yml",
        "nginx/nginx.conf",
        "backend/app/core/config.py",
        "backend/app/admin/router.py",
        "backend/app/mtproto/__init__.py",
        "backend/app/mtproto/availability.py",
        "backend/app/mtproto/models.py",
        "backend/app/mtproto/official_secrets.py",
        "backend/app/mtproto/provisioning.py",
        "backend/app/mtproto/repository.py",
        "backend/app/mtproto/runtime_bridge.py",
        "backend/app/mtproto/service.py",
        ...
        "backend/tests/test_mtproto_admin_ops.py",
        "backend/tests/test_mtproto_api.py",
        "backend/tests/test_mtproto_availability_diagnostics.py",
        "backend/tests/test_mtproto_provisioning.py",
        "backend/tests/test_mtproxy_secret_sync.py",
        "official-mtproxy/Dockerfile",
        "official-mtproxy/entrypoint.sh",
        "official-mtproxy/secret-control.py",
