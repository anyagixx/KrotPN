...
//   PURPOSE: Root visual shell that mounts Matrix runtime, CSS rain fallback, CRT overlays, and Phase-59 route motion behind the admin frontend
...
//
// START_MODULE_MAP
//   VisualShell - Wraps routed admin frontend content with Matrix visual layers and CSS rain fallback
