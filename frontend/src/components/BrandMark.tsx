...
//   PURPOSE: Reusable visible KrotPN logo mark for public, auth, and protected user frontend surfaces
//   SCOPE: Size-bounded PNG logo rendering, optional text lockup, Phase-63 visibility markers, and legacy Phase-56 logo regression compatibility
//   DEPENDS: M-009 (frontend-user), M-069 (brand-assets-favicon-email-logo), M-072 (premium-art-direction-system), M-080 (visible-brand-logo-integration)
...
//   BRAND_MARK_RETINA_SRC - Existing 256x256 email body logo retained as high-DPI fallback without changing email/BIMI semantics
//   BrandMark - Reusable compact logo lockup component
//   default - React component (default export)
// END_MODULE_MAP
//
// START_CHANGE_SUMMARY
//   LAST_CHANGE: v1.0.0 - Added Phase-63 visible KrotPN logo component with bounded asset selection and regression markers.
// END_CHANGE_SUMMARY
//
...
const BRAND_MARK_RETINA_SRC = '/brand/email-logo.png'
